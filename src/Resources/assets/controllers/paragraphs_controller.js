...
export default class extends Controller {
  ...
  static values = {
    prototype: String, maxItems: Number, itemsCount: Number,
  }
  ...
  addItem(event) {
    ...
    setTimeout(() => {
      this.fieldContainerTarget.lastElementChild.dispatchEvent(new CustomEvent('paragraphs:item:added', {
        bubbles: true, detail: {type: type, index: this.index},
      }));
    }, 0);
  }
